...
RSpec.describe Wampproto::Message::Unregister do
  let(:request_id) { 1 }
  ...
  describe ".parse" do
    ...
    context "when valid message" do
      let(:wamp_message) do
        [Wampproto::Message::Type::UNREGISTER, request_id, registration_id]
      end
    ...
    context "when invalid message" do
      let(:wamp_message) do
        [Wampproto::Message::Type::UNREGISTER, request_id, "Options"]
      end
      let(:parse) { subject }
